#!/usr/bin/env python3
"""
html_to_md.py — Convert HTML or a live URL into clean Markdown.
...
Part of markitdown-document-converter — Markdown is the durable source format.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--user-agent",
        default="Mozilla/5.0 (markitdown-document-converter/0.1)",
